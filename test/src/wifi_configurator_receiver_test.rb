...
activity Java::no.datek.network_configurator.NetworkConfiguratorActivity
...
test('broadcast changes title', :ui => false) do |activity|
  begin
    @receiver = $package.WifiConfiguratorReceiver.new
    action = '__no.datek.network_configurator__.WifiConfiguratorReceiver.action'
